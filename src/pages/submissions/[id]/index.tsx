...
function calculateOverallScore(submission: FullSubmission) {
  ...
  const correctToScore = [
    1, 4, 6, 8, 10, 11, 11, 12, 13, 13, 13, 14, 14, 15, 15, 15, 15, 16, 16, 16,
    16, 17, 17, 17, 18, 18, 18, 19, 19, 20, 21, 21, 22, 22, 23, 23, 24, 24, 25,
    25, 26, 26, 26, 27, 27, 28, 28, 28, 29, 29, 30, 30, 31, 31, 32, 33, 33, 34,
    35, 35, 36,
  ];

  return {
    score: correctToScore[totalPredictedCorrect] ?? 0,
